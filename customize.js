...
function completeListItem(item) {
    ...
    item.parentNode.style.textDecoration = "none"; // in css, this would be: "text-decoration: none"
    }
}

class Pillow {
    constructor (style, color, filling, quantity) {
    this.style = style;
    this.color = color;
    this.filling = filling;
    this.quantity = quantity;
    }
    changecolor(dest_color) {
        this.color = dest_color;
    }
}